...
NO_INIT_ZERO(extern crash_info_t crash_info_ram, ".__crash_RAM");


/**
 * @brief Get Crash Information utility
 */
#define GET_CRASH_INFO(PTR)     { PTR = *(crash_info_t *)&crash_info_ram; \
                                  memset((void *)&crash_info_ram, 0, CRASH_RAM_SIZE);}
 ...
 * - xPSR
 */
#define CRASH_HANDLER(msp, signature) {                                          \
